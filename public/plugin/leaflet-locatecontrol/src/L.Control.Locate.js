...
(function (factory, window) {
   ...
   const CompassMarker = LocationMarker.extend({
       ...
       _getIconSVG(options, style) {
           ...
           const h = (r+options.depth + options.weight);
           const path = `M0,0 l${options.width/2},${options.depth} l-${w},0 z`;
           const svgstyle = `transform: rotate(${this._heading}deg)`;
           const svg = `<img src="./plugin/leaflet-locatecontrol/test.gif" width="${w}" height="${h}"  style="${svgstyle}">`+
   ...
   const LocateControl = L.Control.extend({
    ...
    initialZoomLevel: false,
           ...
           compassStyle: {
               ...
               color:       '#fff',
               opacity:     1,
               radius:      40, // How far is the arrow is from the center of of the marker
               width:       40, // Width of the arrow
           ...
           strings: {
               ...
               outsideMapBoundsMsg: "あなたはズーラシアにいないよ！"
           },
